...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2a/045",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2a/045",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2a/045",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2a/045",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2a/045",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2a/045",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2a/045"
    },
    name: {
        en: "Gible",
        fr: "Griknot",
    ...
    description: {
        ...
        ko: "구멍에 숨어서 먹이나 적이\n지나가면 뛰쳐나가 문다.\n기세가 대단해 이가 빠질 때도 있다.",
        "zh-tw": "它潛伏在洞穴裡，當獵物或敵人經過時，它會跳出來咬掉它們。它的攻擊力有時會碎掉牙齒。"
    },
    stage: "Basic",
    attacks: [{
            name: {
