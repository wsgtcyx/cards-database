...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2a/081",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2a/081",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2a/081",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2a/081",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2a/081",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2a/081",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2a/081"
    },
    name: {
        en: "Shaymin",
        fr: "Shaymin",
    ...
    description: {
        ...
        ko: "대기의 독소를 분해해서\n거칠어진 대지를 일순간에\n꽃밭으로 만드는 힘을 가지고 있다.",
        "zh-tw": "它可以溶解空氣中的毒素，讓荒蕪的土地瞬間變成茂盛的花田。"
    },
    stage: "Basic",
    abilities: [{
            type: "Ability",
