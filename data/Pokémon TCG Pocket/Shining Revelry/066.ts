...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2b/066",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2b/066",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2b/066",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2b/066",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2b/066",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2b/066",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2b/066"
    },
    name: {
        en: "Buneary",
        fr: "Laporeille",
    ...
    description: {
        ...
        ko: "양쪽 귀를 말고 있을 때는\n몸이나 마음이 좋지 않다는 뜻이므로\n관리가 필요하다.",
        "zh-tw": "如果Buneary的兩隻耳朵都捲起來，則表明它的身體或精神出了問題。這是神奇寶貝需要照顧的明確信號。"
    },
    stage: "Basic",
    attacks: [{
        name: {
