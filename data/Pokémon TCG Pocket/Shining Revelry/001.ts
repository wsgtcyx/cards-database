...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2b/001",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2b/001",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2b/001",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2b/001",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2b/001",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2b/001",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2b/001"
    },
    name: {
        en: "Weedle",
        fr: "Aspicot",
    ...
    description: {
        ...
        ko: "숲이나 풀밭에 많이 서식한다.\n머리끝에 5cm 정도의\n작고 날카로운 독침을 지니고 있다.",
        "zh-tw": "常見於森林和草原。它的頭頂上有一個約兩英寸長的鋒利有毒倒刺。"
    },
    stage: "Basic",
    attacks: [{
        name: {
