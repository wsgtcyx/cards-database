...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2b/105",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2b/105",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2b/105",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2b/105",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2b/105",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2b/105",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2b/105"
    },
    name: {
        en: "Varoom",
        fr: "Vrombi",
    ...
    description: {
        ...
        ko: "고철 처리장에 방치된 엔진에\n정체불명의 독포켓몬이 들어가\n탄생한 것으로 전해지고 있다.",
        "zh-tw": "據說這只神奇寶貝是在一種未知的有毒神奇寶貝進入並激發了廢品加工廠留下的引擎時誕生的。"
    },
    stage: "Basic",
    attacks: [{
        name: {
