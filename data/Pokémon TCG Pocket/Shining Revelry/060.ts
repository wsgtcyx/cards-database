...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2b/060",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2b/060",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2b/060",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2b/060",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2b/060",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2b/060",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2b/060"
    },
    name: {
        en: "Jigglypuff",
        fr: "Rondoudou",
    ...
    description: {
        ...
        ko: "배를 크게 부풀려서\n신비한 멜로디를 노래한다.\n들으면 바로 졸음이 쏟아진다.",
        "zh-tw": "它的胃膨脹得很厲害，唱著神秘的旋律。如果你聽到這個旋律，你會立刻昏昏欲睡。"
    },
    stage: "Basic",
    attacks: [{
        name: {
