...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2b/061",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2b/061",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2b/061",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2b/061",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2b/061",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2b/061",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2b/061"
    },
    name: {
        en: "Wigglytuff",
        fr: "Grodoudou",
    ...
    description: {
        ...
        ko: "얇고 고운 털을 지니고 있다.\n화나게 하면 몸을 점점 부풀리며\n덮쳐 오기 때문에 주의가 필요하다.",
        "zh-tw": "它有非常細膩的皮毛。注意不要讓它生氣，否則它可能會不斷膨脹並用身體猛烈撞擊。"
    },
    stage: "Stage1",
    abilities: [{
        type: "Ability",
