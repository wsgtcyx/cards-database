...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2/172",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2/172",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2/172",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2/172",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2/172",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2/172",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2/172"
    },
    name: {
        en: "Spiritomb",
        fr: "Spiritomb",
    ...
    description: {
        ...
        ko: "항상 나쁜 짓만 하고 있었기에\n신비한 술법에 의해 본모습을\n쐐기돌에 속박당했다.",
        "zh-tw": "它不斷的惡作劇和惡行導致它被一個神秘的咒語束縛在一個奇怪的基石上。"
    },
    stage: "Basic",
    attacks: [{
            name: {
