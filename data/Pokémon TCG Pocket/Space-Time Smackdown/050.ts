...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2/050",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2/050",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2/050",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2/050",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2/050",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2/050",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2/050"
    },
    name: {
        en: "Manaphy",
        fr: "Manaphy",
    ...
    description: {
        ...
        ko: "태어났을 때부터 가지고 있는\n이상한 힘을 쓰면 어떤 포켓몬과도\n마음이 서로 통하게 된다.",
        "zh-tw": "它天生就擁有一種神奇的力量，可以與任何種類的神奇寶貝產生聯繫。"
    },
    stage: "Basic",
    attacks: [{
            name: {
