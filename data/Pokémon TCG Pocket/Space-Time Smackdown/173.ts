...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2/173",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2/173",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2/173",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2/173",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2/173",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2/173",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2/173"
    },
    name: {
        en: "Croagunk",
        fr: "Cradopaud",
    ...
    description: {
        ...
        ko: "독주머니를 부풀리며 울어서\n주변에 으스스한 소리를 퍼트린 후\n상대가 풀죽으면 독찌르기를 한다.",
        "zh-tw": "它會膨脹毒囊，使整個區域充滿奇怪的聲音，並用毒刺攻擊畏縮的對手。"
    },
    stage: "Basic",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "為遊戲中的每個神奇寶貝投一枚硬幣。這次攻擊對每個頭造成 20 點傷害。"
            }
        }],
    weaknesses: [{
            type: "Fighting",
