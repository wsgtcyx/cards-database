...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A2/179",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A2/179",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A2/179",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A2/179",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A2/179",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A2/179",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A2/179"
    },
    name: {
        en: "Regigigas",
        fr: "Regigigas",
    ...
    description: {
        ...
        ko: "특수한 빙산이나 암석,\n마그마에서 자신의 모습과 닮은\n포켓몬을 만들었다고 전해진다.",
        "zh-tw": "據說，它用特殊的冰山、岩石和岩漿創造了與自己相似的神奇寶貝。"
    },
    stage: "Basic",
    attacks: [{
            name: {
