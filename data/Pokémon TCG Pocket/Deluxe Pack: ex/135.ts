...
const card: Card = {
	set: Set,
	image: {
		en: "https://game.pokemontcgpocket.app/en/tcgp/A4b/135",
		de: "https://game.pokemontcgpocket.app/de/tcgp/A4b/135",
		es: "https://game.pokemontcgpocket.app/es/tcgp/A4b/135",
		fr: "https://game.pokemontcgpocket.app/fr/tcgp/A4b/135",
		it: "https://game.pokemontcgpocket.app/it/tcgp/A4b/135",
		"zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A4b/135",
		"pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A4b/135"
	},
	name: {
		en: "Magneton",
		fr: "Magnéton",
	...
	description: {
		...
		ko: "3개의 코일은 강한 자력으로\n연결되어 있다. 가까이 다가가면\n강한 귀울림에 시달리게 된다.",
		"zh-tw": "三個磁鐵礦通過強大的磁力連接在一起。如果距離太近，就會出現耳痛。"
	}
};
