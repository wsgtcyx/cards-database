...
const card: Card = {
	set: Set,
	image: {
		en: "https://game.pokemontcgpocket.app/en/tcgp/A4b/198",
		de: "https://game.pokemontcgpocket.app/de/tcgp/A4b/198",
		es: "https://game.pokemontcgpocket.app/es/tcgp/A4b/198",
		fr: "https://game.pokemontcgpocket.app/fr/tcgp/A4b/198",
		it: "https://game.pokemontcgpocket.app/it/tcgp/A4b/198",
		"zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A4b/198",
		"pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A4b/198"
	},
	name: {
		en: "Sudowoodo",
		fr: "Simularbre",
	...
	description: {
		...
		ko: "항상 나무인 척하고 있다.\n몸의 구조는 식물보다\n돌이나 바위에 가까운 듯하다.",
		"zh-tw": "雖然它總是假裝是一棵樹，但它的構成看起來更像岩石而不是植被。"
	},
	stage: "Basic",
	attacks: [
		{
			...
			effect: {
				...
				"zh-tw": "如果對手的活躍神奇寶貝是神奇寶貝 {ex}，則此攻擊造成的傷害增加 30 點。"
			}
		}
	],
	weaknesses: [
