...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/020",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/020",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/020",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/020",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/020",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/020",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/020"
    },
    name: {
        en: "Tsareena",
        fr: "Sucreine",
    ...
    description: {
        ...
        ko: "자존심이 강하고 공격적이지만\n꼭지의 왕관을 건드리면\n금세 얌전해진다고 한다.",
        "zh-tw": "這只神奇寶貝驕傲且具有攻擊性。然而，據說，如果有人觸摸查雷納花萼上的王冠，查雷納就會立即變得平靜。"
    },
    stage: "Stage2",
    attacks: [{
            name: {
