...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/031",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/031",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/031",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/031",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/031",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/031",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/031"
    },
    name: {
        en: "Litten",
        fr: "Flamiaou",
    ...
    description: {
        ...
        ko: "집요하게 따라다니면\n마음을 열지 않는다. 친밀해져도\n과도한 스킨십은 금물이다.",
        "zh-tw": "如果你太努力地想要接近它，它就不會向你敞開。即使你們確實變得親密，給予它太多的感情仍然是禁忌。"
    },
    stage: "Basic",
    attacks: [{
            name: {
