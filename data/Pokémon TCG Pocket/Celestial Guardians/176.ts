...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/176",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/176",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/176",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/176",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/176",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/176",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/176"
    },
    name: {
        en: "Drampa",
        fr: "Draïeul",
    ...
    description: {
        ...
        ko: "해발 3000m가 넘는\n산에 산다. 드물게 마을로\n내려와 아이들과 논다.",
        "zh-tw": "它稱之為家的山脈高近兩英里。在極少數情況下，它會降落到下方城鎮與孩子們一起玩耍。"
    },
    stage: "Basic",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "如果你的任何後備神奇寶貝受到傷害，則此攻擊會造成 50 點額外傷害。"
            }
        }],
    retreat: 2,
    boosters: ["solgaleo"]
