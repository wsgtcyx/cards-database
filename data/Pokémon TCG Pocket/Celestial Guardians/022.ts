...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/022",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/022",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/022",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/022",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/022",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/022",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/022"
    },
    name: {
        en: "Golisopod",
        fr: "Sarmuraï",
    ...
    description: {
        ...
        "zh-tw": "為了獲勝，它會不惜一切代價，利用每一個機會，用前腿上的小爪子消滅對手。"
    },
    stage: "Stage1",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "如果本回合這只神奇寶貝從你的替補席移動到活躍位置，則這次攻擊造成的傷害增加 60 點。"
            }
        }],
    weaknesses: [{
            type: "Fire",
