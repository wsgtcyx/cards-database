...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/160",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/160",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/160",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/160",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/160",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/160",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/160"
    },
    name: {
        en: "Alolan Marowak",
    ...
    description: {
        ...
        ko: "손에 든 뼈에 불을 붙여\n동료를 추모하는 춤을\n밤새도록 춘다.",
        "zh-tw": "這只神奇寶貝會點燃它所持有的骨頭，並在夜間跳舞，以哀悼死去的盟友。"
    },
    stage: "Stage1",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "翻轉 2 個硬幣。這次攻擊對每個頭造成 70 點傷害。如果其中至少有 1 個為正面，則對手的活躍神奇寶貝現在被燒毀。"
            }
        }],
    weaknesses: [{
            type: "Water",
