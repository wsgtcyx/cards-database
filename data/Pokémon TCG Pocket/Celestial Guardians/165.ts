...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/165",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/165",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/165",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/165",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/165",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/165",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/165"
    },
    name: {
        en: "Oricorio",
        fr: "Plumeline",
    ...
    description: {
        ...
        ko: "진노랑꿀을 빨아들인 모습.\n경쾌한 스텝으로 상대에게 접근하여\n전격을 담은 펀치로 KO시킨다.",
        "zh-tw": "這種形式的 Oricorio 啜飲著黃色的花蜜。它以敏捷的步伐接近對手，然後用電拳將他們擊倒。"
    },
    stage: "Basic",
    abilities: [{
            type: "Ability",
