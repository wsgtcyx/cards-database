...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/135",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/135",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/135",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/135",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/135",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/135",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/135"
    },
    name: {
        en: "Toucannon",
        fr: "Bazoucan",
    ...
    description: {
        ...
        ko: "동료와 부리를 부딪히며\n커뮤니케이션한다. 부딪히는 강도나\n횟수로 기분을 전달한다.",
        "zh-tw": "它們用喙與同類進行交流。攻擊的強度和次數可以告訴對方他們的感受。"
    },
    stage: "Stage2",
    attacks: [{
            name: {
