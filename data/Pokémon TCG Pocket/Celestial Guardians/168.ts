...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A3/168",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A3/168",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A3/168",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A3/168",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A3/168",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A3/168",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A3/168"
    },
    name: {
        en: "Comfey",
        fr: "Guérilande",
    ...
    description: {
        ...
        "zh-tw": "康菲用藤蔓採摘花朵，並用它們裝飾自己。出於某種原因，花朵一旦附著在紫草上就不會枯萎。"
    },
    stage: "Basic",
    abilities: [{
            type: "Ability",
            ...
            effect: {
                ...
                "zh-tw": "你的每隻附有 {P} 能量的神奇寶貝都會從所有特殊狀況中恢復，並且不會受到任何特殊狀況的影響。"
            }
        }],
    attacks: [{
            name: {
