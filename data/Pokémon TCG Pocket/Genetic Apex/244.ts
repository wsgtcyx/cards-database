...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1/244",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1/244",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1/244",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1/244",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1/244",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1/244",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1/244"
    },
    name: {
        en: "Dragonite",
        fr: "Dracolosse",
    ...
    attacks: [{
            ...
            effect: {
                ...
                "zh-tw": "隨機選擇 1 只對手的神奇寶貝 4 次。每次選擇一隻神奇寶貝，對其造成 50 點傷害。"
            }
        }],
    retreat: 3,
    rarity: "One Star",
    description: {
        ...
        ko: "드넓은 바다 어딘가에는\n망나뇽만이 모여 사는\n섬이 있다고 한다.",
        "zh-tw": "據說在海洋的某個地方有一座島嶼，這些島嶼就聚集在那裡。只有他們住在那裡。"
    },
    boosters: ["mewtwo"]
};
export default card;
