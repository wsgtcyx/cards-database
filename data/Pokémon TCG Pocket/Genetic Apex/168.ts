...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1/168",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1/168",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1/168",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1/168",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1/168",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1/168",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1/168"
    },
    name: {
        en: "Nidoqueen",
        fr: "Nidoqueen",
    ...
    description: {
        ...
        ko: "공격보다는 방어가 특기다.\n갑옷 같은 비늘로 어떠한\n공격에도 새끼를 지킨다.",
        "zh-tw": "尼多女王更擅長防守而不是進攻。這款神奇寶貝擁有像盔甲一樣的鱗片，可以保護它的孩子免受任何類型的攻擊。"
    },
    boosters: ["pikachu"]
};
export default card;
