...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1/177",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1/177",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1/177",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1/177",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1/177",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1/177",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1/177"
    },
    name: {
        en: "Weezing",
        fr: "Smogogo",
    ...
    abilities: [{
            ...
            effect: {
                ...
                "zh-tw": "在你的回合中，如果這只神奇寶貝位於活躍位置，你可以使對手的活躍神奇寶貝中毒。"
            }
        }],
    attacks: [{
            cost: ["Darkness"],
    ...
    description: {
        ...
        "zh-tw": "如果雙胞胎 Koffing 中的一個膨脹，另一個就會收縮。它不斷地混合有毒氣體。"
    },
    boosters: ["mewtwo"]
};
export default card;
