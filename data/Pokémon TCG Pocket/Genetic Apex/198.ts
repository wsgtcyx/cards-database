...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1/198",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1/198",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1/198",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1/198",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1/198",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1/198",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1/198"
    },
    name: {
        en: "Farfetch'd",
        fr: "Canarticho",
    ...
    description: {
        ...
        ko: "날개로 쥐고 있는 파 줄기를\n칼처럼 휘둘러 상대를 베어버린다.\n몹시 허기질 때는 먹기도 한다.",
        "zh-tw": "這只神奇寶貝翅膀上的莖可以作為劍來砍倒對手。在嚴峻的情況下，莖也可以作為食物。"
    },
