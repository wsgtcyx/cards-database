...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1a/006",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1a/006",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1a/006",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1a/006",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1a/006",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1a/006",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1a/006"
    },
    name: {
        en: "Serperior",
        fr: "Majaspic",
    ...
    description: {
        ...
        ko: "샤로다의 고상한 눈동자로\n쏘아보아도 태연할 정도로 강한\n상대에게만 진정한 실력을 발휘한다.",
        "zh-tw": "它只會在面對強大的對手時全力以赴，而這些對手不會被蛇皮里奧高貴的目光所困擾。"
    },
    stage: "Stage2",
    abilities: [{
            type: "Ability",
