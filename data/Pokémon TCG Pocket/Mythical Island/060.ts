...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1a/060",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1a/060",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1a/060",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1a/060",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1a/060",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1a/060",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1a/060"
    },
    name: {
        en: "Tauros",
        fr: "Tauros",
    ...
    description: {
        ...
        ko: "꼬리로 자신의 몸을\n때리기 시작하면 위험하다.\n맹렬한 스피드로 덤벼든다.",
        "zh-tw": "當金牛座開始用尾巴抽打自己時，這是一個警告，神奇寶貝即將以驚人的速度衝鋒。"
    },
    stage: "Basic",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "如果對手的活躍神奇寶貝是神奇寶貝 {ex}，則此攻擊造成的傷害增加 80 點。"
            }
        }],
    weaknesses: [{
            type: "Fighting",
