...
const card: Card = {
    set: Set,
    image: {
        de: "https://game.pokemontcgpocket.app/de/tcgp/A1a/071",
        es: "https://game.pokemontcgpocket.app/es/tcgp/A1a/071",
        fr: "https://game.pokemontcgpocket.app/fr/tcgp/A1a/071",
        it: "https://game.pokemontcgpocket.app/it/tcgp/A1a/071",
        "pt-br": "https://game.pokemontcgpocket.app/pt/tcgp/A1a/071",
        "zh-tw": "https://game.pokemontcgpocket.app/zh-tw/tcgp/A1a/071",
        en: "https://game.pokemontcgpocket.app/en/tcgp/A1a/071"
    },
    name: {
        en: "Salandit",
        fr: "Tritox",
    ...
    description: {
        ...
        "zh-tw": "它會嘲弄獵物，將它們引誘到狹窄的岩石區域，然後向它們噴灑有毒氣體，使它們頭暈並把它們打倒。"
    },
    stage: "Basic",
    attacks: [{
            name: {
            ...
            effect: {
                ...
                "zh-tw": "如果對手的活躍寶可夢中毒，則這次攻擊造成的傷害增加 40 點。"
            }
        }],
    weaknesses: [{
            type: "Water",
